...
const Contact = () => {
    return (
        <div
            ...
            style={{backgroundImage: "url('https://www.bits-pilani.ac.in/wp-content/uploads/BITS-Pilani-campus-31.jpg')"}}>
                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col items-center space-y-2 mt-4">
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-600">+91 7386253324</span>
                        </div>

                        <div className="flex items-center">
                            <FaEnvelope className="text-blue-500 mr-2"/>
                            <span className="text-gray-600">anshulasc151976@gmail.com</span>
                        </div>

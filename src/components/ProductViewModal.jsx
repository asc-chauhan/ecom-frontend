      ...
      <Dialog open={open} as="div" className="relative z-10" onClose={close} __demoMode>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              transition
              className="relative transition-all overflow-hidden rounded-lg bg-white shadow-xl md:max-w-[620px] md:min-w-[620px] w-full" 
            >

                {image && (
                    <div className='flex justify-center aspect-3/'>
                        <img
                        src={image}
                        alt={productName}></img>
                    </div>

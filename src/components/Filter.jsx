    ...
    return (
        <div className="flex lg:flex-row flex-col-reverse lg:justify-between justify-center items-center gap-4">
            ...
            <div className="relative flex items-center 2xl:w-[450px] sm:w-[420px] w-full">
                ...
                />
                <FaSearch className = "absolute left-3 text-slate-600 size={20} cursor-pointer"/>
            </div>
            ...
            <div className="flex sm:flex-row flex-col gap-4 items-center">
                ...
                <button
                    className="flex items-center gap-2 bg-rose-700 text-white px-3 py-2 rounded-md transition duration-300 ease-in shadow-md focus:outline-none cursor-pointer">
